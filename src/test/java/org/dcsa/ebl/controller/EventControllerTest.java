...
public class EventControllerTest {
  ...
  void init() {
    ...
    shipmentEvent.setDocumentID(UUID.fromString("5e51e72c-d872-11ea-811c-0f8f10a32ea1"));
  ...
  @Test
  @DisplayName("Get events should throw bad request for incorrect equipmentReference length.")
    ...
    webTestClient
        ...
        .uri(
            uriBuilder ->
                uriBuilder
                    .path("/events")
                    .queryParam("equipmentReference", "ABC709951ABC709951ABC709951ABC609951564")
                    .build())
        .accept(MediaType.APPLICATION_JSON)
        .exchange()
        .expectStatus()
  ...
  void testEventsShouldReturnShipmentEvents() {
    ...
    Mockito.when(eBLShipmentEventService.findAllExtended(Mockito.any()))
        .thenReturn(Flux.just(shipmentEvent));
