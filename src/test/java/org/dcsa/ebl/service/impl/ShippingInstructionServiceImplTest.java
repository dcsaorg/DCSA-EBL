...
class ShippingInstructionServiceImplTest {
  ...
  private void initTO() {
    ...
    ConsignmentItemTO.ConsignmentItemTOBuilder consignmentItemTOBuilder = ConsignmentItemTO.builder();
  ...
  class CreateShippingInstructionTest {
    ...
    void testCreateShippingInstructionWithEverything() {
      ...
      when(consignmentItemService.createConsignmentItemsByShippingInstructionReferenceAndTOs(any(), any(), any())).thenReturn(Mono.just(List.of(consignmentItemTO)));
  ...
  class GetShippingInstructionTest {
    ...
    void testGetShippingInstructionForInvalidID() {
      ...
      StepVerifier.create(
              shippingInstructionServiceImpl.findById(invalidShippingInstructionReference))
          .expectErrorSatisfies(
              throwable -> {
                Assertions.assertTrue(throwable instanceof ConcreteRequestErrorMessageException);
                assertEquals(
