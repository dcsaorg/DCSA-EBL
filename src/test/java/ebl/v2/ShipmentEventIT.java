...
//                .ifValidationFails(LogDetail.ALL)
  ...
  void testGetAllEventsByCarrierBookingReference() {
    ...
    // TODO: Assert that document references contain the carrier booking reference
  ...
  void testGetAllEventsByCarrierBookingReferenceWithEventCreatedDateTimeRange() {
    ...
    given()
        ...
        .statusCode(200)
        .contentType(ContentType.JSON)
        // The test data includes 3 shipment events for this case. Given the narrow date range, it
        // seems acceptable to
  ...
  void testGetAllEventsByEventCreatedDateTimeRange() {
    ...
    given()
        ...
        .statusCode(200)
        .contentType(ContentType.JSON)
        // The test data includes 1 shipment event for this case. Given the narrow date range, it
        // seems acceptable to
    ...
    // 832deb4bd4ea4b728430b857c59bd057
    // (Needs a fix for DDT-928 first)
    // Note: The carrier booking reference must be present in the range due to the date range (but
    // others could
    // be present as well).
    ;
  }
